...
//   function addStyledText(text, fontSize = 12, fontStyle = 'normal', color = colors.primary, indent = 0) {
...
//   // Section 2: Personality Analysis
//   addSection('2. PERSONALITY ANALYSIS');
//   yPosition += 12;
...
//   const oaTextMaxWidth = usableWidth - 40;
...
//   addSection('3. CORRECTED SIGNATURE');
...
//   // Section 4: Benefits
//   addSection('4. BENEFITS OF CORRECTED SIGNATURE');
...
//   // Section 5: Mistakes in Handwriting
//   addSection('5. MISTAKES IN HANDWRITING');
//   yPosition += 12;
...
//   addSection('5. HOW TO PRACTICE YOUR NEW SIGNATURE');
//   yPosition += 15;
...
//   // Section 6: Legal
//   addSection('6. SHOULD YOU CHANGE SIGN LEGALLY?');

//   const legalTitle = "Understanding Legal Signature Changes";
...
//   const legalPadding = 20;
//   const legalLineHeight = 16;
//   const legalBodyLines = doc.splitTextToSize(legalBody, usableWidth - 2 * legalPadding);
//   const legalBoxHeight = (legalBodyLines.length * legalLineHeight) + (legalPadding * 2);

//   checkPageBreak(legalBoxHeight + 20);

//   setColor([245, 238, 250], 'fill');
//   doc.roundedRect(margin, yPosition, usableWidth, legalBoxHeight, 10, 10, 'F');

//   const boxCenterX = margin + usableWidth / 2;

//   doc.setFont('times', 'bold');
//   doc.setFontSize(12);
//   setColor([0, 0, 0], 'text');
//   doc.text(legalTitle, boxCenterX, yPosition + legalPadding, { align: 'center' });

//   doc.setFont('times', 'normal');
//   doc.setFontSize(10);
//   setColor([33, 37, 41], 'text');
//   doc.text(legalBodyLines, boxCenterX, yPosition + legalPadding + 20, { align: 'center' });

//   yPosition += legalBoxHeight + 20;
